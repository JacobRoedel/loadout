...
pub(crate) fn installation_hint_for(os: &str, name: &str) -> Option<&'static str> {
    match (os, name) {
        ...
        ("macos", "dotnet") => Some("brew install --cask dotnet-sdk"),
        ("macos", "php") => Some("brew install php"),
        ("macos", "composer") => Some("brew install composer"),
        ("macos", "elixir" | "mix") => Some("brew install elixir"),
        ("macos", "dart") => Some("brew install dart-sdk"),
        ("macos", "flutter") => Some("brew install --cask flutter"),
        ...
        ("linux", "dotnet") => Some("https://dotnet.microsoft.com/download"),
        ("linux", "php") => Some("sudo apt install php-cli"),
        ("linux", "composer") => Some("sudo apt install composer"),
        ("linux", "elixir" | "mix") => Some("sudo apt install elixir"),
        ("linux", "dart") => Some("https://dart.dev/get-dart"),
        ("linux", "flutter") => Some("https://docs.flutter.dev/get-started/install"),
        ...
        ("windows", "dotnet") => Some("winget install Microsoft.DotNet.SDK.8"),
        ("windows", "php") => Some("winget install PHP.PHP"),
        ("windows", "composer") => Some("winget install Composer.Composer"),
        ("windows", "elixir" | "mix") => Some("https://elixir-lang.org/install.html"),
        ("windows", "dart") => Some("winget install DartLang.DartSDK"),
        ("windows", "flutter") => Some("https://docs.flutter.dev/get-started/install/windows"),
