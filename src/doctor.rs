...
pub(crate) fn doc_url_for(name: &str) -> Option<&'static str> {
    match name {
        ...
        "dotnet" => Some("https://dotnet.microsoft.com/download"),
        "php" => Some("https://www.php.net/downloads"),
        "composer" => Some("https://getcomposer.org/download/"),
        "elixir" | "mix" => Some("https://elixir-lang.org/install.html"),
        "dart" => Some("https://dart.dev/get-dart"),
        "flutter" => Some("https://docs.flutter.dev/get-started/install"),
        ...
        "nix" => Some("https://nixos.org/download/"),
        "devcontainer" => Some("https://github.com/devcontainers/cli"),
        "brew" => Some("https://brew.sh"),
